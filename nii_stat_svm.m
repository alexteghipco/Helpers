...
%
% A.T. -- script edited by request to return all feature loadings above the
% initial arbitrary z-threshold of 1 (instead of top 10 positive and
% negative). Will display warning that this is not the typical script we
% use in NiiStat. Use at your own peril, this is experimental and it likely
% does not make sense for you to look at all of the features!
...
% Edited by A.T. for Nick...
warning('USING AN EXPERIMENTAL/UNOFFICIAL VERSION OF NIISTAT THAT REPORTS ALL FEATURE LOADINGS!!! CONTINUE AT YOUR OWN PERIL!')
disp('USING AN EXPERIMENTAL/UNOFFICIAL VERSION OF NIISTAT THAT REPORTS ALL FEATURE LOADINGS!!! CONTINUE AT YOUR OWN PERIL!')
n_reported_pos = sum (featureLoadings > 0);
n_reported_neg = sum (featureLoadings < 0);
